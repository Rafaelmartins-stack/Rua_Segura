...
function resolveInspection(isFining) {
    ...
    if (isFining) {
        if (isIrregular) {
            ...
            else if (car.hasPhoneInfraction) addFeedback('+150 USO DE CELULAR!', car.x, car.y - 50, COLORS.trafficGreen);
            else addFeedback('+150 INFRAÇÕES!', car.x, car.y - 50, COLORS.trafficGreen);
